...
void MAX77986_Charger_initial_settings(uint8_t Term_Voltage, uint8_t Curr_input_limit, uint8_t Fast_chg_curr_LSB);
...
void MAX77986_Charger_initial_settings(uint8_t Term_Voltage, uint8_t Curr_input_limit, uint8_t Fast_chg_curr_LSB)
{
   ...
   Register_Write_Charger(CHG_CNFG_04,Term_Voltage,1);
   Register_Write_Charger(CHG_CNFG_09,Curr_input_limit,1);
   Register_Write_Charger(CHG_CNFG_02, (0x7F & Fast_chg_curr_LSB),1);
...
void Enable_Reverse_OTG(uint8_t Reverse_Voltage, uint8_t Reverse_Current_lim)
{
	 Register_Write_Charger(CHG_CNFG_06,0x0C,1);  //Unlocking Charge protection
	 Register_Write_Charger(CHG_CNFG_00,0x0A,1);
	 Register_Write_Charger(CHG_CNFG_11, Reverse_Voltage, 1);
	 Register_Write_Charger(CHG_CNFG_10, 0xFF & ((1 << 7) |Reverse_Current_lim), 1);
}

void Mask_and_Read_Interrupts()
{
