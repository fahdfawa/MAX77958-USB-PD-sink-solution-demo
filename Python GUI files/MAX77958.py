...
def Get_Src_Cap():
    ...
    buffer_gs = []
    while True:
        received_data_gs = s.readline().decode("UTF-8").strip()
        if received_data_gs:
           buffer_gs.append(received_data_gs)
           if received_data_gs == 'expected_data':
              break
          
    buffer_gs.pop()     
    formatted_buffer_gs = []
    for element in buffer_gs:
        value = int(element, 16)
        formatted_string = f'0x{value:08X}'
        formatted_buffer_gs.append(formatted_string)   
        
    No_of_PDOs_gs_Tb.delete("0.0","end")
    Power_Role_gs_Tb.delete("0.0","end")
    Data_Role_gs_Tb.delete("0.0","end")
    PDO1_gs_Tb.delete("0.0","end")
    PDO2_gs_Tb.delete("0.0","end")
    PDO3_gs_Tb.delete("0.0","end")
    PDO4_gs_Tb.delete("0.0","end")
    PDO5_gs_Tb.delete("0.0","end")
    PDO6_gs_Tb.delete("0.0","end")
    PDO7_gs_Tb.delete("0.0","end")
    PDO8_gs_Tb.delete("0.0","end")
    
    No_of_PDOs_gs_Tb.insert("0.0","0x" + buffer_gs[0])
    Power_Role_gs_Tb.insert("0.0","0x" + buffer_gs[1])
    Data_Role_gs_Tb.insert("0.0","0x" + buffer_gs[2])
    PDO1_gs_Tb.insert("0.0",formatted_buffer_gs[3])
    PDO2_gs_Tb.insert("0.0",formatted_buffer_gs[4])
    PDO3_gs_Tb.insert("0.0",formatted_buffer_gs[5])
    PDO4_gs_Tb.insert("0.0",formatted_buffer_gs[6])
    PDO5_gs_Tb.insert("0.0",formatted_buffer_gs[7])
    PDO6_gs_Tb.insert("0.0",formatted_buffer_gs[8])
    PDO7_gs_Tb.insert("0.0",formatted_buffer_gs[9])
    PDO8_gs_Tb.insert("0.0",formatted_buffer_gs[10])
...
def Initialize_Charger():
    ...
    try:
        ...
        if 0 <= term_vg_dec <= 255 and 0 <= Charger_inp_dec <= 255 and 0 <= Fast_curr_dec <= 511:
            ...
            high_byte_bytes_Ft_ct = bytes([high_byte])
...
MAX77958_Image = ctk.CTkImage(dark_image= Image.open(resource_path("MAX77958EVKIT.png")),size=(600,600))
MAX77958_Image_Label = ctk.CTkLabel(tab0, image =MAX77958_Image,text = '')
MAX77958_Image_Label.grid(row=0,column=1,padx =25,pady =60,sticky="NW")
...
frame11 = ctk.CTkFrame(tab2,  width = 1225, height = 650, border_width=3)
frame11.place(x=150,y= 60)
frame11.pack_propagate(False)

Command_data_get_src = ctk.CTkLabel(frame10, text="Command Data", width = 10)
Command_data_get_src.grid(row = 0, column = 0, padx = 10 , pady = 10, sticky = "W")
get_src_Btn = ctk.CTkButton(frame11,width = 100, height =10, text = "Write",command = Get_Src_Cap)
get_src_Btn.grid(row = 0, column = 1, padx = 10, pady= 10,sticky = "E")

No_of_PDOs_gs = ctk.CTkLabel(frame11, text="Number of PDOs", width = 10)
No_of_PDOs_gs.grid(row = 1, column = 0, padx = 10 , pady = 10, sticky = "W")
No_of_PDOs_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
No_of_PDOs_gs_Tb.grid(row = 1, column = 1, padx = 10, pady= 10)

Power_Role_gs = ctk.CTkLabel(frame11, text="Power Role", width = 20)
Power_Role_gs.grid(row = 2, column = 0, padx = 10 , pady = 10,sticky = "W")
Power_Role_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
Power_Role_gs_Tb.grid(row = 2, column = 1, padx = 10, pady= 10)

Data_Role_gs = ctk.CTkLabel(frame11, text="Data Role", width = 20)
Data_Role_gs.grid(row = 3, column = 0, padx = 10 , pady = 10,sticky = "W")
Data_Role_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
Data_Role_gs_Tb.grid(row = 3, column = 1, padx = 10, pady= 10)

PDO1_gs = ctk.CTkLabel(frame11, text="PDO1", width = 20)
PDO1_gs.grid(row = 4, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO1_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO1_gs_Tb.grid(row = 4, column = 1, padx = 10, pady= 10)

PDO2_gs = ctk.CTkLabel(frame11, text="PDO2", width = 20)
PDO2_gs.grid(row = 5, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO2_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO2_gs_Tb.grid(row = 5, column = 1, padx = 10, pady= 10)

PDO3_gs = ctk.CTkLabel(frame11, text="PDO3", width = 20)
PDO3_gs.grid(row = 6, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO3_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO3_gs_Tb.grid(row = 6, column = 1, padx = 10, pady= 10)

PDO4_gs = ctk.CTkLabel(frame11, text="PDO4", width = 20)
PDO4_gs.grid(row = 7, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO4_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO4_gs_Tb.grid(row = 7, column = 1, padx = 10, pady= 10)

PDO5_gs = ctk.CTkLabel(frame11, text="PDO5", width = 20)
PDO5_gs.grid(row = 8, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO5_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO5_gs_Tb.grid(row = 8, column = 1, padx = 10, pady= 10)

PDO6_gs = ctk.CTkLabel(frame11, text="PDO6", width = 20)
PDO6_gs.grid(row = 9, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO6_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO6_gs_Tb.grid(row = 9, column = 1, padx = 10, pady= 10)

PDO7_gs = ctk.CTkLabel(frame11, text="PDO7", width = 20)
PDO7_gs.grid(row = 10, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO7_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO7_gs_Tb.grid(row = 10, column = 1, padx = 10, pady= 10)

PDO8_gs = ctk.CTkLabel(frame11, text="PDO8", width = 20)
PDO8_gs.grid(row = 11, column = 0, padx = 10 , pady = 10,sticky = "W")
PDO8_gs_Tb = ctk.CTkTextbox(frame11,width = 1030, height =10)
PDO8_gs_Tb.grid(row = 11, column = 1, padx = 10, pady= 10)

frames["Get SrcCap (0x31)"] = frame11
...
Charger_Settings_Label = ctk.CTkLabel(frame_quick_run_3, text="Charger Settings (MAX77962)", width = 20,font=("Helvetica", 14))
...
Chg_term_vg_slider = ctk.CTkSlider(frame_quick_run_3_1, from_=0, to=127, number_of_steps= 127, width = 830, command = Charge_Termiantn_Volt_Set)
Chg_term_vg_slider.grid(row = 0, column = 3, padx = 20 , pady = 3,sticky = "W")

Charger_input_current_slider = ctk.CTkSlider(frame_quick_run_3_1, from_=0, to=127,width = 830,command=Charge_Termiantn_chg_lct_lim_Set)
Charger_input_current_slider.grid(row = 1, column = 3, padx = 20 , pady = 3,sticky = "W")

Fast_Charge_slider = ctk.CTkSlider(frame_quick_run_3_1, from_=0, to=511, width = 830,command=Charge_Termiantn_fast_lim_Set)
Fast_Charge_slider.grid(row = 2, column = 3, padx = 20 , pady = 3,sticky = "W")


#########Setting Initial Voltage Plugin##########
